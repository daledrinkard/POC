...
gpt_instance_ctrl_t g_aux_timer_ctrl;
#if 0
const gpt_extended_pwm_cfg_t g_aux_timer_pwm_extend =
{
...
#endif
const gpt_extended_cfg_t g_aux_timer_extend =
        { .gtioca =
...
#if 0
    .p_pwm_cfg                   = &g_aux_timer_pwm_extend,
#else
          .p_pwm_cfg = NULL,
#endif
#if 0
...
const timer_cfg_t g_aux_timer_cfg =
{ .mode = TIMER_MODE_ONE_SHOT_PULSE,
/* Actual period: 1 seconds. Actual duty: 50%. */.period_counts = (uint32_t) 0x7270e00,
  .duty_cycle_counts = 0x3938700, .source_div = (timer_source_div_t) 0, .channel = 3, .p_callback = aux_timer_cb,
...
const timer_instance_t g_aux_timer =
{ .p_ctrl = &g_aux_timer_ctrl, .p_cfg = &g_aux_timer_cfg, .p_api = &g_timer_on_gpt };
gpt_instance_ctrl_t g_freerun_timer_ctrl;
#if 0
const gpt_extended_pwm_cfg_t g_freerun_timer_pwm_extend =
{
    .trough_ipl          = (BSP_IRQ_DISABLED),
...
#endif
const gpt_extended_cfg_t g_freerun_timer_extend =
        { .gtioca =
        { .output_enabled = false, .stop_level = GPT_PIN_LEVEL_LOW },
          .gtiocb =
          { .output_enabled = false, .stop_level = GPT_PIN_LEVEL_LOW },
    ...
    .capture_b_irq       = VECTOR_NUMBER_GPT1_CAPTURE_COMPARE_B,
          ...
          .compare_match_status = (0U << 1U) | 0U, .capture_filter_gtioca = GPT_CAPTURE_FILTER_NONE, .capture_filter_gtiocb =
                  GPT_CAPTURE_FILTER_NONE,
#if 0
    .p_pwm_cfg                   = &g_freerun_timer_pwm_extend,
#else
          .p_pwm_cfg = NULL,
#endif
#if 0
...
const timer_cfg_t g_freerun_timer_cfg =
{ .mode = TIMER_MODE_PERIODIC,
/* Actual period: 35.791394125 seconds. Actual duty: 49.99999998835847%. */.period_counts = (uint32_t) 0xffffffff,
  .duty_cycle_counts = 0x7fffffff, .source_div = (timer_source_div_t) 0, .channel = 1, .p_callback = NULL,
  /** If NULL then do not add & */
#if defined(NULL)
    .p_context           = NULL,
#else
  .p_context = &NULL,
#endif
  .p_extend = &g_freerun_timer_extend,
...
/* Instance structure to use this module. */
const timer_instance_t g_freerun_timer =
{ .p_ctrl = &g_freerun_timer_ctrl, .p_cfg = &g_freerun_timer_cfg, .p_api = &g_timer_on_gpt };
gpt_instance_ctrl_t g_sample_timer_ctrl;
#if 0
const gpt_extended_pwm_cfg_t g_sample_timer_pwm_extend =
{
    .trough_ipl          = (BSP_IRQ_DISABLED),
...
#endif
const gpt_extended_cfg_t g_sample_timer_extend =
        { .gtioca =
        { .output_enabled = false, .stop_level = GPT_PIN_LEVEL_LOW },
          .gtiocb =
          { .output_enabled = false, .stop_level = GPT_PIN_LEVEL_LOW },
    ...
    .capture_b_irq       = VECTOR_NUMBER_GPT2_CAPTURE_COMPARE_B,
          ...
          .compare_match_status = (0U << 1U) | 0U, .capture_filter_gtioca = GPT_CAPTURE_FILTER_NONE, .capture_filter_gtiocb =
                  GPT_CAPTURE_FILTER_NONE,
#if 0
    .p_pwm_cfg                   = &g_sample_timer_pwm_extend,
#else
          .p_pwm_cfg = NULL,
#endif
#if 0
...
const timer_cfg_t g_sample_timer_cfg =
{ .mode = TIMER_MODE_PERIODIC,
/* Actual period: 0.000001 seconds. Actual duty: 50%. */.period_counts = (uint32_t) 0x78,
  .duty_cycle_counts = 0x3c, .source_div = (timer_source_div_t) 0, .channel = 2, .p_callback = sample_timer_cb,
  /** If NULL then do not add & */
#if defined(NULL)
    .p_context           = NULL,
#else
  .p_context = &NULL,
#endif
  .p_extend = &g_sample_timer_extend,
  .cycle_end_ipl = (1),
...
/* Instance structure to use this module. */
const timer_instance_t g_sample_timer =
{ .p_ctrl = &g_sample_timer_ctrl, .p_cfg = &g_sample_timer_cfg, .p_api = &g_timer_on_gpt };
gpt_instance_ctrl_t g_one_second_timer_ctrl;
#if 0
const gpt_extended_pwm_cfg_t g_one_second_timer_pwm_extend =
{
    .trough_ipl          = (BSP_IRQ_DISABLED),
...
#endif
const gpt_extended_cfg_t g_one_second_timer_extend =
        { .gtioca =
        { .output_enabled = false, .stop_level = GPT_PIN_LEVEL_LOW },
          .gtiocb =
          { .output_enabled = false, .stop_level = GPT_PIN_LEVEL_LOW },
    ...
    .capture_b_irq       = VECTOR_NUMBER_GPT0_CAPTURE_COMPARE_B,
          ...
          .compare_match_status = (0U << 1U) | 0U, .capture_filter_gtioca = GPT_CAPTURE_FILTER_NONE, .capture_filter_gtiocb =
                  GPT_CAPTURE_FILTER_NONE,
#if 0
    .p_pwm_cfg                   = &g_one_second_timer_pwm_extend,
#else
          .p_pwm_cfg = NULL,
#endif
#if 0
...
const timer_cfg_t g_one_second_timer_cfg =
{ .mode = TIMER_MODE_ONE_SHOT,
/* Actual period: 1 seconds. Actual duty: 50%. */.period_counts = (uint32_t) 0x7270e00,
  .duty_cycle_counts = 0x3938700, .source_div = (timer_source_div_t) 0, .channel = 0, .p_callback = code_timer_callback,
  /** If NULL then do not add & */
#if defined(NULL)
    .p_context           = NULL,
#else
  .p_context = &NULL,
#endif
  .p_extend = &g_one_second_timer_extend,
  .cycle_end_ipl = (1),
...
/* Instance structure to use this module. */
const timer_instance_t g_one_second_timer =
{ .p_ctrl = &g_one_second_timer_ctrl, .p_cfg = &g_one_second_timer_cfg, .p_api = &g_timer_on_gpt };
