...
icu_instance_ctrl_t g_SW1_irq_ctrl;
const external_irq_cfg_t g_SW1_irq_cfg =
...
const external_irq_instance_t g_SW1_irq =
{ .p_ctrl = &g_SW1_irq_ctrl, .p_cfg = &g_SW1_irq_cfg, .p_api = &g_external_irq_on_icu };
icu_instance_ctrl_t g_SW2_irq_ctrl;
const external_irq_cfg_t g_SW2_irq_cfg =
{ .channel = 12, .trigger = EXTERNAL_IRQ_TRIG_RISING, .filter_enable = true, .clock_source_div =
          EXTERNAL_IRQ_CLOCK_SOURCE_DIV_64,
  .p_callback = NULL,
  /** If NULL then do not add & */
#if defined(NULL)
...
/* Instance structure to use this module. */
const external_irq_instance_t g_SW2_irq =
{ .p_ctrl = &g_SW2_irq_ctrl, .p_cfg = &g_SW2_irq_cfg, .p_api = &g_external_irq_on_icu };
/* MIPI PHY Macros */
