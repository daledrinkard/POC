...
/* Actual period: 0.0005461333333333333 seconds. Actual duty: 50%. */.period_counts = (uint32_t) 0x10000,
  .duty_cycle_counts = 0x8000, .source_div = (timer_source_div_t) 0, .channel = 3, .p_callback = NULL,
...
/* Actual period: 0.01 seconds. Actual duty: 50%. */.period_counts = (uint32_t) 0x124f80,
  .duty_cycle_counts = 0x927c0, .source_div = (timer_source_div_t) 0, .channel = 2, .p_callback = NULL,
  /** If NULL then do not add & */
#if defined(NULL)
    .p_context           = NULL,
#else
