...
extern const external_irq_instance_t g_SW1_irq;

/** Access the ICU instance using these structures when calling API functions directly (::p_api is not used). */
extern icu_instance_ctrl_t g_SW1_irq_ctrl;
extern const external_irq_cfg_t g_SW1_irq_cfg;

#ifndef NULL
void NULL(external_irq_callback_args_t *p_args);
#endif
/** External IRQ on ICU Instance. */
extern const external_irq_instance_t g_SW2_irq;

/** Access the ICU instance using these structures when calling API functions directly (::p_api is not used). */
extern icu_instance_ctrl_t g_SW2_irq_ctrl;
extern const external_irq_cfg_t g_SW2_irq_cfg;
