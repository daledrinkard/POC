...
color 0A
cls
echo press space to remove Renesas.RA.5.6.0.pack from the support folder
pause
del /Q C:\Users\daled\.eclipse\com.renesas.platform_351115138\internal\projectgen\ra\packs\Renesas.RA.5.6.0.pack
echo press space to copy pack without QSPI to support folder
copy ./FSP_no_qspi/Renesas.RA.5.6.0.pack C:\Users\daled\.eclipse\com.renesas.platform_351115138\internal\projectgen\ra\packs\Renesas.RA.5.6.0.pack
pause
