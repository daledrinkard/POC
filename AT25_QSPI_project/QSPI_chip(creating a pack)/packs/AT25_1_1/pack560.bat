echo off
echo "Pack 5.6.0  e2studio 2024-10"
color 0A
...
cls
echo "press space to remove 5.6.0 pack from e2studio 2024-10 support area pack folder"
pause
...
echo "press space to remove the pack file from the e2studio 2024-10 install folders"
pause
...
echo "press space to rebuild 5.6.0 pack"
pause
