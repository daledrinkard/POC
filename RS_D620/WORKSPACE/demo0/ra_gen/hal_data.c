...
sci_uart_instance_ctrl_t     g_comm_uart_ctrl;

            baud_setting_t               g_comm_uart_baud_setting =
            {
            ...
            const sci_uart_extended_cfg_t g_comm_uart_cfg_extend =
            {
                .clock                = SCI_UART_CLOCK_INT,
                .rx_edge_start          = SCI_UART_START_BIT_FALLING_EDGE,
                .noise_cancel         = SCI_UART_NOISE_CANCELLATION_DISABLE,
                .rx_fifo_trigger        = SCI_UART_RX_FIFO_TRIGGER_MAX,
                .p_baud_setting         = &g_comm_uart_baud_setting,
            ...
            const uart_cfg_t g_comm_uart_cfg =
            {
                .channel             = 0,
                ...
                .p_callback          = comm_cb,
                .p_context           = NULL,
                .p_extend            = &g_comm_uart_cfg_extend,
...
const uart_instance_t g_comm_uart =
{
    .p_ctrl        = &g_comm_uart_ctrl,
    .p_cfg         = &g_comm_uart_cfg,
    .p_api         = &g_uart_on_sci
};
gpt_instance_ctrl_t g_T2_ctrl;
#if 0
const gpt_extended_pwm_cfg_t g_T2_pwm_extend =
{
...
#endif
const gpt_extended_cfg_t g_T2_extend =
{
