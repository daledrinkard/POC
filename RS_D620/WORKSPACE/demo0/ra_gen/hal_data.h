...
/** UART on SCI Instance. */
            extern const uart_instance_t      g_comm_uart;

            /** Access the UART instance using these structures when calling API functions directly (::p_api is not used). */
            extern sci_uart_instance_ctrl_t     g_comm_uart_ctrl;
            extern const uart_cfg_t g_comm_uart_cfg;
            extern const sci_uart_extended_cfg_t g_comm_uart_cfg_extend;

            #ifndef comm_cb
            void comm_cb(uart_callback_args_t * p_args);
            #endif
/** Timer on GPT Instance. */
extern const timer_instance_t g_T2;

/** Access the GPT instance using these structures when calling API functions directly (::p_api is not used). */
extern gpt_instance_ctrl_t g_T2_ctrl;
extern const timer_cfg_t g_T2_cfg;
