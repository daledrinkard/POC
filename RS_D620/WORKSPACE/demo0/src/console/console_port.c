...
#include "console_port.h"  // IWYU pragma: keep
#if   (0 == BSP_CFG_RTOS) /* Bare METAL */
#include "hal_data.h"  // IWYU pragma: keep (provides bsp_leds_t etc. for downstream includers)
...
#if 0    //@@@ this is a hack to get the comm bus working, but it should be a separate console
